...
public class Main1 {
    public static Customer createCustomer(String line) throws ParseException {
        ...
        Customer customer = new Customer(Long.parseLong(c1_details[0]),c1_details[1],c1_details[2],dateFormat.parse(c1_details[3]),Double.parseDouble(c1_details[4]),Double.parseDouble(c1_details[5]),Double.parseDouble(c1_details[7]),dateFormat.parse(c1_details[6]));
        return customer;
